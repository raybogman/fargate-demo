...
return e}var v=function Buttons(t){var n=Object(h.a)(m,t.classes),r=t.appearance,e=t.isSameWidth,i=t.textAlign,s=t.border,c=t.borderColor,f=t.borderWidth,g=t.borderRadius,p=t.marginTop,b=t.marginRight,y=t.marginBottom,v=t.marginLeft,w=t.paddingTop,x=t.paddingRight,A=t.paddingBottom,T=t.paddingLeft,j=t.children,O=t.cssClasses,k=void 0===O?[]:O,L=n["".concat(r)],R=Object(l.useRef)(null),I=u.a.useState(0),S=d()(I,2),W=S[0],C=S[1],J={"--buttonMinWidth":W?W+"px":null},B=a()({border:s,borderColor:c,borderWidth:f,borderRadius:g,marginTop:p,marginRight:b,marginBottom:y,marginLeft:v,paddingTop:w,paddingRight:x,paddingBottom:A,paddingLeft:T},J)
